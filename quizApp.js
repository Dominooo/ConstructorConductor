...
var devin = new User ('devin', 'devin@email.com', 'poopoo', 9000);
var jeramy = new User ('jeramy', 'jeramy@email.com', 'manchester', 1);
var jon = new User ('jon', 'jon@email.com', 'riseagainst', 666);
users.push(devin, jeramy, jon);
...
var q3 = new Question ("T/F: In Javascript, == doesn't check 'type' but just the value - where === checks type and value", ['true', 'false'], 'true', 7);
